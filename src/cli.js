...
function help() {
  console.log(`agent-task-scope v0.1.0

Usage:
  agent-task-scope --path FILE
  agent-task-scope FILE --markdown
  agent-task-scope FILE --sarif > results.sarif
  agent-task-scope FILE --annotations
  agent-task-scope FILE --redact
`)
}
...
try {
  ...
  console.error(`agent-task-scope: ${error.message}`)
  process.exit(2)
}
